...
export default function AProposDeMoi(props) {
	...
	useEffect(() => {
		async function fetchGithubStats() {
			const response = await fetch("https://api.github.com/users/BloodEvolution");
					...
					<div className="right-view">
						<ScrollAnimation animateIn="fadeIn" animateOnce delay={200}>
							...
							<div className="tech-and-cv">
								...
								<ButtonCV href={language.aboutMePage.cvUrl} target="_blank" data-splitbee-event="Download CV">
								    {language.aboutMePage.cvLabel}
								</ButtonCV>
							</div>
						</ScrollAnimation>
					</div>
